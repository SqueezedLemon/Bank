...
namespace Bank.Persistance.Migrations
{
    ...
    [Migration("20231223124445_RefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bank.Domain.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Bank.Domain.Balance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bank.Domain.Balance", b =>
                {
                    b.HasOne("Bank.Domain.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("Bank.Domain.Balance", "UserId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Bank.Domain.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
